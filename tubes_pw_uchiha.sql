...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 03 Jan 2023 pada 16.00
...
CREATE TABLE `users` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `biodata` text COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, 'Faisal', 'fiuls@gmail.com', NULL, '$2y$10$5Tk.yWbFYMQuwU5HP9CZXu..ah2SlHXV9ZRnhk7XUVJGZIiona8sK', 1, NULL, '2022-12-21 06:04:28', '2023-01-03 06:35:08', 'Reviewer gadget dengan kepribadian yang baik dan humble. Bertanggung jawab dan hebat'),
(2, 'Mustofa', 'mus@gmail.com', NULL, '$2y$10$xCeDOqUgJIgiSL6990uNIeS3vOKGUj8wGc.48sdtuYb8dlzR8p1yK', 1, NULL, '2022-12-29 18:49:17', '2022-12-29 18:49:17', 'Tukang review gadget dengan mendetail'),
(3, 'Zaki', 'jek@gmail.com', NULL, '$2y$10$P6Yk600a7G3MTeVpFdhuIuW6k77/aDe7oRlPmYBolIvLuzrTQGJB6', 1, NULL, '2022-12-29 19:03:13', '2022-12-29 21:27:15', 'Periview handal dengan kosa kata yang mudah dipahami'),
(8, 'ikhsan', 'ihksan@gmail.com', NULL, '$2y$10$qdleAALmJFsIHtjGU6dJUORYrSf96CzPz/I0OywODzKWJCZW.Eiz2', 0, NULL, '2023-01-02 19:08:42', '2023-01-02 19:08:42', NULL);
